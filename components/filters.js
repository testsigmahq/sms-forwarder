      ...
      .catch((err) => {
        ...
        console.log(
          getCurrentTime("ERROR") +
            "Error occurred while fetching all filters, Error::",
          err
        );
      });
  }, []);
  ...
  const handleToggleChange = (id, status) => {
    ...
    Database.updateFilterForStatus(id, newStatus)
      ...
      .catch((error) => {
        ...
        console.log(
          getCurrentTime("ERROR") + "Error updating filter status, Error::",
          error
        );
      });
  };
            ...
            <View style={styles.card}>
              ...
              <View style={styles.switchContainer}>
                <Switch
                  ...
                  onValueChange={() =>
                    handleToggleChange(filterItem?.id, filterItem?.status)
                  }
                  trackColor={{ false: "#767577", true: "white" }}
                  thumbColor={
                    filterItem.status === "active" ? "lightgreen" : "#f4f3f4"
                  }
